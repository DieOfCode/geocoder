    ...
    def get_answer(self) -> str:
        while True:
            ...
            if self._status == "start":
                ...
                print("Формат ввода адресса: Город Улица Номер дома")
                print("Чтобы прекратить работу введите конец\n")
            ...
            if self._status == "wait_answer":
                if self.raw_address == "":
                    print(
                        "Ну, ты подумай, не торопись. И введи адрес. Не надо нам "
                        "тут баловаться")
                    self._status = "start"
                ...
                try:
                    ...
                    geocoder_data_exception.exception_handling(self.raw_address)
                    ...
                    logging.exception(
                        "address:{} ,{} {}".format(self.raw_address, "АЛЯРМ!!!!!",
